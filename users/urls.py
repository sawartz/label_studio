...
urlpatterns = [
    ...
    path('user/user_login_r/', views.user_login_r, name='user_login_r'),
    path('user/user_signup_r/', views.user_signup_r, name='user_signup_r'),
    path('user/admin_r/', views.admin_r, name='admin_r'),
